...
import {creatementore, fetchmentore, togglementoreStatus, updatementore,} from "@/store/slices/mentore-slice";
...
export const MentorePage = () => {
    ...
    const [selectedmentore, setSelectedmentore] = useState<MentorData | undefined>();
